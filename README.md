...
## Introduction
A template for couscous generated static html documents by ![OVAC4U](`https://github.com/ovac/ovac-couscous-template`) inspired by the [ElephantlyCouscous](https://github.com/elephantly/ElephantlyCouscous) template design and the [Template-Dark](https://github.com/CouscousPHP/Template-Dark) template configuration with widgets and google analytics.
